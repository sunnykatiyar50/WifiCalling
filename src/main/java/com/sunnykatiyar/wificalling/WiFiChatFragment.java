...
public class WiFiChatFragment extends Fragment {
    ...
    private View view;
    private WifiChatManager wifiChatManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.button1).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        if (wifiChatManager != null) {
                            wifiChatManager.write(chatLine.getText().toString().getBytes());
    ...
    public void setWifiChatManager(WifiChatManager obj) {
        wifiChatManager = obj;
    }
    ...
    public class ChatMessageAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                ...
                v = vi.inflate(android.R.layout.simple_list_item_1, null,false);
            }
            ...
            if (message != null && !message.isEmpty()) {
                ...
                if (nameText != null) {
                    ...
                    }else {nameText.setTextAppearance(getActivity(),R.style.boldText);}
                }
            }
            return v;
        }
