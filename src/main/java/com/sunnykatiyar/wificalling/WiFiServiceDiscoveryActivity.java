...
public class WiFiServiceDiscoveryActivity extends Activity implements
    ...
    private void discoverService() { manager.setDnsSdResponseListeners(channel,new DnsSdServiceResponseListener() {
        @Override
        public void onDnsSdServiceAvailable(String instanceName,String registrationType, WifiP2pDevice srcDevice)
        {
            ...
            if (fragment != null) {
                ...
                Log.d(TAG, "onBonjourServiceAvailable "+ instanceName);
                    ...
                    /**
                     * A new TXT record is available. Pick up the buddy name.
                     */
            @Override
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case MY_HANDLE:
                Object obj = msg.obj;
                (chatFragment).setWifiChatManager((WifiChatManager) obj);
        }
        return true;
    }
    ...
    public void onConnectionInfoAvailable(WifiP2pInfo p2pInfo) {
        ...
        }else
        {
            ...
            handler = new WifiClientSocketHandler(( this).getHandler(),p2pInfo.groupOwnerAddress);
            handler.start();
        }
